...
const Organisationpackages = ({onMenuItemClick}) => {
          ...
          <Table sx={{ borderCollapse: "separate", borderSpacing: "0px 16px" }}>
            ...
            <TableBody>
              {appointments.map((ride) => (
                <TableRow key={ride.rideID} onClick={()=>{onMenuItemClick("Organisationpackagesinfo")}} sx={{ background: "#FAFAFA", paddingX: "24px"  }}>
